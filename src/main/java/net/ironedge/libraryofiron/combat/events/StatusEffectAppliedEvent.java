...
public class StatusEffectAppliedEvent extends LoIEvent {
    private final LivingEntity target;
    private final StatusEffectCap.StatusEffect effect;

    public StatusEffectAppliedEvent(LivingEntity target, StatusEffectCap.StatusEffect effect) {
        this.target = target;
        this.effect = effect;
    }
    ...
    public StatusEffectCap.StatusEffect getEffect() { return effect; }
}
