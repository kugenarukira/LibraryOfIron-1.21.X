...
public final class PhysicsStripView {

    private PhysicsStripView() {}

    public static PhysicsSimulation simulation(String simulationId) {
        return PhysicsSystem.get().getById(simulationId);
    }

    public static Vector3f point(String simulationId, StripTopology topo, int row, int col) {
    ...
    public static List<Vector3f> row(String simulationId, StripTopology topo, int row) {
